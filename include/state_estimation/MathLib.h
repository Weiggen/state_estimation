...
public:
    ...
    Eigen::MatrixXd M_resize(const Eigen::MatrixXd& M, const int& Dim);
    Eigen::MatrixXd TensorContraction(const std::vector<Eigen::MatrixXd>& multi_M, const std::vector<std::vector<std::vector<double>>>& T);
};
